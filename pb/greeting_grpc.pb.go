...
type GreetingServiceClient interface {
	Greeting(ctx context.Context, in *GreetingServiceRequest, opts ...grpc.CallOption) (*GreetingServiceResponse, error)
}
...
func (c *greetingServiceClient) Greeting(ctx context.Context, in *GreetingServiceRequest, opts ...grpc.CallOption) (*GreetingServiceResponse, error) {
	out := new(GreetingServiceResponse)
...
type GreetingServiceServer interface {
	Greeting(context.Context, *GreetingServiceRequest) (*GreetingServiceResponse, error)
...
func (UnimplementedGreetingServiceServer) Greeting(context.Context, *GreetingServiceRequest) (*GreetingServiceResponse, error) {
